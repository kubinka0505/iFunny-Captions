...
- `Settings` :
  ...
  - `Optimize_Factor` : GIF file size reduction. (`gifsicle` encoder) **Values Range: 0 → 3`**. **Default is `3`**.
  - `FFmpeg_Location` : The FFmpeg static executable binary file.
  Done in case when You have it somewhere else on Your computer.
...
- `Wrap_Factor` : Text-wrapping factor used to break the words. **Is dependent on `Max_Width`**. (Unknown Formula) **Default is 2**.
2. Open `Run.sh`
...
**[In case of problems create issue](https://github.com/kubinka0505/iFunny-Captions/issues/new "In case of problems create issue")**.

---
### Supported GIF services 🗃️
| Tenor | Giphy | Gfycat |
|:-----:|:-----:|:------:|
| [![Tenor](https://cdn.discordapp.com/attachments/267356180064501760/778241233297997844/Tenor_Logo.png "Tenor")](https://tenor.com/ "Tenor") |[![Giphy](https://cdn.discordapp.com/attachments/267356180064501760/778241495508713482/Giphy_Logo.png "Giphy")](https://giphy.com/ "Giphy")  | [![Gfycat](https://cdn.discordapp.com/attachments/267356180064501760/778241493034336296/Gfycat_Logo.png "Gfycat")](https://gfycat.com/ "Gfycat") |
---
### Comparisons 🔢
Fonts may differ.
