...
- <code>requests</code>
- <code>textwrap</code>
- <b><code>ffmpeg.exe</code></b> ([Download, unzip and move <code>ffmpeg.exe</code> from <code>bin</code> to main folder](https://www.videohelp.com/software/ffmpeg/old-versions ""))
